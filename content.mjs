...
export const content = {
  tr: {
    ...
    nav: {
      ...
      cta: 'Demo Talep Et',
      demoPreview: { href: 'https://enflow-mock-demo.vercel.app', label: 'İnteraktif Önizleme' },
  ...
  en: {
    ...
    nav: {
      ...
      cta: 'Request a Demo',
      demoPreview: { href: 'https://enflow-mock-demo.vercel.app', label: 'Interactive Preview' },
